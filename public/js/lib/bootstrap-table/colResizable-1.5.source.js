...
(function($){ 	
	...
	* sum of all columns can exceed the table width in some case (if fixed is set to false and table has some kind 
	* of max-width).
	* @param {jQuery ref} t - table object	
	*/
	...
	var onResize = function(){
		for(t in tables){		
			...
			t.removeClass(SIGNATURE);						//firefox doesn't like layout-fixed in some case
